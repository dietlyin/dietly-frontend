...
export type LightsailClientConfigType = Partial<
...
export type LightsailClientResolvedConfigType =
...
> {
  ...
  constructor(
    ...[configuration]: __CheckOptionalClientConfig<LightsailClientConfig>
  );
  destroy(): void;
}
