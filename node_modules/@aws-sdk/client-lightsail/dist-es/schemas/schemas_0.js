...
import { AccessDeniedException, AccountSetupInProgressException, InvalidInputException, NotFoundException, OperationFailureException, RegionSetupInProgressException, ServiceException, UnauthenticatedException, } from "../models/errors";
import { LightsailServiceException } from "../models/LightsailServiceException";
const _s_registry = TypeRegistry.for(_s);
export var LightsailServiceException$ = [-3, _s, "LightsailServiceException", 0, [], []];
...
export var AccountSetupInProgressException$ = [-3, n0, _ASIPE,
    { [_e]: _c, [_hE]: 428 },
    [_co, _d, _m, _t],
    [0, 0, 0, 0]
];
...
export var OperationFailureException$ = [-3, n0, _OFE,
    { [_e]: _c, [_hE]: 400 },
    [_co, _d, _m, _t],
    [0, 0, 0, 0]
];
n0_registry.registerError(OperationFailureException$, OperationFailureException);
export var RegionSetupInProgressException$ = [-3, n0, _RSIPE,
    { [_e]: _c, [_hE]: 428 },
    [_co, _d, _m, _t],
    [0, 0, 0, 0]
];
...
export var UnauthenticatedException$ = [-3, n0, _UE,
    { [_e]: _c, [_hE]: 401 },
    [_co, _d, _m, _t],
    [0, 0, 0, 0]
];
...
export var AccessRules$ = [3, n0, _AR,
    0,
    [_gO, _aPO],
    [0, 2]
];
export var AccountLevelBpaSync$ = [3, n0, _ALBS,
    0,
    [_st, _lSA, _m, _bIL],
    [0, 4, 0, 2]
];
export var AddOn$ = [3, n0, _AO,
    0,
    [_n, _st, _sTOD, _nSTOD, _th, _du],
    [0, 0, 0, 0, 0, 0]
];
export var AddOnRequest$ = [3, n0, _AOR,
    0,
    [_aOT, _aSAOR, _sIOIR],
...
export var AllocateStaticIpResult$ = [3, n0, _ASIRl,
    0,
    [_o],
    [() => OperationList]
];
export var AttachCertificateToDistributionRequest$ = [3, n0, _ACTDR,
    0,
    [_dN, _cN],
    [0, 0], 2
];
export var AttachCertificateToDistributionResult$ = [3, n0, _ACTDRt,
    0,
    [_op],
    [() => Operation$]
];
export var AttachDiskRequest$ = [3, n0, _ADR,
    0,
    [_dNi, _iN, _dP, _aM],
    [0, 0, 0, 2], 3
];
export var AttachDiskResult$ = [3, n0, _ADRt,
    0,
    [_o],
    [() => OperationList]
];
export var AttachedDisk$ = [3, n0, _AD,
    0,
    [_pa, _sIG],
    [0, 1]
];
export var AttachInstancesToLoadBalancerRequest$ = [3, n0, _AITLBR,
    0,
    [_lBN, _iNn],
    [0, 64 | 0], 2
];
export var AttachInstancesToLoadBalancerResult$ = [3, n0, _AITLBRt,
    0,
    [_o],
    [() => OperationList]
];
export var AttachLoadBalancerTlsCertificateRequest$ = [3, n0, _ALBTCR,
    0,
    [_lBN, _cN],
    [0, 0], 2
];
export var AttachLoadBalancerTlsCertificateResult$ = [3, n0, _ALBTCRt,
    0,
    [_o],
    [() => OperationList]
];
export var AttachStaticIpRequest$ = [3, n0, _ASIRt,
    0,
    [_sIN, _iN],
    [0, 0], 2
];
export var AttachStaticIpResult$ = [3, n0, _ASIRtt,
    0,
    [_o],
    [() => OperationList]
];
export var AutoSnapshotAddOnRequest$ = [3, n0, _ASAOR,
    0,
    [_sTOD],
    [0]
];
export var AutoSnapshotDetails$ = [3, n0, _ASD,
    0,
    [_da, _cA, _st, _fAD],
...
export var BucketAccessLogConfig$ = [3, n0, _BALC,
    0,
    [_en, _des, _pr],
    [2, 0, 0], 1
];
export var BucketBundle$ = [3, n0, _BB,
    0,
    [_bIu, _n, _pri, _sPMIG, _tPMIG, _iA],
    [0, 0, 1, 1, 1, 2]
];
export var BucketCorsConfig$ = [3, n0, _BCC,
    0,
    [_ru],
    [() => BucketCorsRules]
];
export var BucketCorsRule$ = [3, n0, _BCR,
    0,
    [_aMl, _aO, _i, _aH, _eH, _mAS],
    [64 | 0, 64 | 0, 0, 64 | 0, 64 | 0, 1], 2
];
export var BucketState$ = [3, n0, _BS,
    0,
    [_co, _m],
    [0, 0]
];
export var Bundle$ = [3, n0, _Bun,
    0,
...
export var CacheBehaviorPerPath$ = [3, n0, _CBPP,
    0,
    [_pa, _b],
    [0, 0]
];
export var CacheSettings$ = [3, n0, _CS,
    0,
...
export var CertificateSummary$ = [3, n0, _CSe,
    0,
    [_cAe, _cN, _dNo, _cD, _ta],
    [0, 0, 0, () => Certificate$, () => TagList]
];
export var CloseInstancePublicPortsRequest$ = [3, n0, _CIPPR,
    0,
    [_pI, _iN],
    [() => PortInfo$, 0], 2
];
export var CloseInstancePublicPortsResult$ = [3, n0, _CIPPRl,
    0,
    [_op],
    [() => Operation$]
];
export var CloudFormationStackRecord$ = [3, n0, _CFSR,
    0,
    [_n, _a, _cA, _l, _rT, _stat, _sI, _dI],
    [0, 0, 4, () => ResourceLocation$, 0, 0, () => CloudFormationStackRecordSourceInfoList, () => DestinationInfo$]
];
export var CloudFormationStackRecordSourceInfo$ = [3, n0, _CFSRSI,
    0,
    [_rT, _n, _a],
    [0, 0, 0]
];
...
export var ContainerService$ = [3, n0, _CSo,
    0,
...
export var ContainerServiceDeployment$ = [3, n0, _CSD,
    0,
    [_v, _stat, _con, _pE, _cA],
    [1, 0, () => ContainerMap, () => ContainerServiceEndpoint$, 4]
];
export var ContainerServiceDeploymentRequest$ = [3, n0, _CSDR,
    0,
    [_con, _pE],
    [() => ContainerMap, () => EndpointRequest$]
];
export var ContainerServiceECRImagePullerRole$ = [3, n0, _CSECRIPR,
    0,
    [_iA, _pA],
    [2, 0]
];
export var ContainerServiceECRImagePullerRoleRequest$ = [3, n0, _CSECRIPRR,
    0,
    [_iA],
    [2]
];
export var ContainerServiceEndpoint$ = [3, n0, _CSE,
    0,
    [_cNo, _cPo, _hC],
    [0, 1, () => ContainerServiceHealthCheckConfig$]
];
export var ContainerServiceHealthCheckConfig$ = [3, n0, _CSHCC,
    0,
    [_hT, _uT, _tS, _iS, _pa, _sCu],
    [1, 1, 1, 1, 0, 0]
];
export var ContainerServiceLogEvent$ = [3, n0, _CSLE,
    0,
    [_cA, _m],
    [4, 0]
];
export var ContainerServicePower$ = [3, n0, _CSP,
    0,
    [_pIo, _pri, _cC, _rSIG, _n, _iA],
    [0, 1, 1, 1, 0, 2]
];
export var ContainerServiceRegistryLogin$ = [3, n0, _CSRL,
    0,
    [_us, _pas, _eA, _re],
    [0, 0, 4, 0]
];
export var ContainerServicesListResult$ = [3, n0, _CSLR,
    0,
    [_cS],
    [() => ContainerServiceList]
];
export var ContainerServiceStateDetail$ = [3, n0, _CSSD,
    0,
    [_co, _m],
    [0, 0]
];
export var CookieObject$ = [3, n0, _CO,
    0,
    [_opt, _cAL],
    [0, 64 | 0]
];
export var CopySnapshotRequest$ = [3, n0, _CSR,
    0,
    [_tSN, _sR, _sSN, _sRN, _rD, _uLRAS],
    [0, 0, 0, 0, 0, 2], 2
];
export var CopySnapshotResult$ = [3, n0, _CSRo,
    0,
    [_o],
    [() => OperationList]
];
export var CostEstimate$ = [3, n0, _CE,
    0,
    [_uTs, _rBT],
    [0, () => EstimatesByTime]
];
export var CreateBucketAccessKeyRequest$ = [3, n0, _CBAKR,
    0,
    [_bN],
    [0], 1
];
export var CreateBucketAccessKeyResult$ = [3, n0, _CBAKRr,
    0,
    [_aK, _o],
...
export var CreateCertificateRequest$ = [3, n0, _CCR,
    0,
    [_cN, _dNo, _sAN, _ta],
    [0, 0, 64 | 0, () => TagList], 2
];
export var CreateCertificateResult$ = [3, n0, _CCRr,
    0,
    [_ce, _o],
    [() => CertificateSummary$, () => OperationList]
];
export var CreateCloudFormationStackRequest$ = [3, n0, _CCFSR,
    0,
    [_in],
    [() => InstanceEntryList], 1
];
export var CreateCloudFormationStackResult$ = [3, n0, _CCFSRr,
    0,
    [_o],
    [() => OperationList]
];
...
export var CreateContainerServiceDeploymentRequest$ = [3, n0, _CCSDR,
    0,
    [_sN, _con, _pE],
    [[0, 1], () => ContainerMap, () => EndpointRequest$], 1
];
export var CreateContainerServiceDeploymentResult$ = [3, n0, _CCSDRr,
    0,
    [_cSo],
    [() => ContainerService$]
];
export var CreateContainerServiceRegistryLoginRequest$ = [3, n0, _CCSRLR,
    0,
    [],
    []
];
export var CreateContainerServiceRegistryLoginResult$ = [3, n0, _CCSRLRr,
    0,
    [_rL],
    [() => ContainerServiceRegistryLogin$]
];
export var CreateContainerServiceRequest$ = [3, n0, _CCSR,
    0,
...
export var CreateContainerServiceResult$ = [3, n0, _CCSRr,
    0,
    [_cSo],
    [() => ContainerService$]
];
export var CreateDiskFromSnapshotRequest$ = [3, n0, _CDFSR,
    0,
    [_dNi, _aZ, _sIG, _dSN, _ta, _aOd, _sDN, _rD, _uLRAS],
    [0, 0, 1, 0, () => TagList, () => AddOnRequestList, 0, 0, 2], 3
];
export var CreateDiskFromSnapshotResult$ = [3, n0, _CDFSRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateDiskRequest$ = [3, n0, _CDR,
    0,
    [_dNi, _aZ, _sIG, _ta, _aOd],
    [0, 0, 1, () => TagList, () => AddOnRequestList], 3
];
export var CreateDiskResult$ = [3, n0, _CDRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateDiskSnapshotRequest$ = [3, n0, _CDSR,
    0,
    [_dSN, _dNi, _iN, _ta],
    [0, 0, 0, () => TagList], 1
];
export var CreateDiskSnapshotResult$ = [3, n0, _CDSRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateDistributionRequest$ = [3, n0, _CDRre,
    0,
...
export var CreateDistributionResult$ = [3, n0, _CDRrea,
    0,
    [_dis, _op],
    [() => LightsailDistribution$, () => Operation$]
];
export var CreateDomainEntryRequest$ = [3, n0, _CDER,
    0,
    [_dNo, _dE],
    [0, () => DomainEntry$], 2
];
export var CreateDomainEntryResult$ = [3, n0, _CDERr,
    0,
    [_op],
    [() => Operation$]
];
export var CreateDomainRequest$ = [3, n0, _CDRreat,
    0,
    [_dNo, _ta],
    [0, () => TagList], 1
];
export var CreateDomainResult$ = [3, n0, _CDRreate,
    0,
    [_op],
    [() => Operation$]
];
export var CreateGUISessionAccessDetailsRequest$ = [3, n0, _CGUISADR,
    0,
    [_rN],
    [0], 1
];
export var CreateGUISessionAccessDetailsResult$ = [3, n0, _CGUISADRr,
    0,
    [_rN, _st, _pC, _fR, _ses],
    [0, 0, 1, 0, [() => Sessions, 0]]
];
export var CreateInstancesFromSnapshotRequest$ = [3, n0, _CIFSR,
    0,
...
export var CreateInstancesFromSnapshotResult$ = [3, n0, _CIFSRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateInstanceSnapshotRequest$ = [3, n0, _CISR,
    0,
    [_iSN, _iN, _ta],
    [0, 0, () => TagList], 2
];
export var CreateInstanceSnapshotResult$ = [3, n0, _CISRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateInstancesRequest$ = [3, n0, _CIR,
    0,
    [_iNn, _aZ, _bI, _bIu, _cIN, _uD, _kPN, _ta, _aOd, _iAT],
    [64 | 0, 0, 0, 0, 0, 0, 0, () => TagList, () => AddOnRequestList, 0], 4
];
export var CreateInstancesResult$ = [3, n0, _CIRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateKeyPairRequest$ = [3, n0, _CKPR,
    0,
    [_kPN, _ta],
    [0, () => TagList], 1
];
export var CreateKeyPairResult$ = [3, n0, _CKPRr,
    0,
    [_kP, _pKB, _pKBr, _op],
    [() => KeyPair$, 0, 0, () => Operation$]
];
export var CreateLoadBalancerRequest$ = [3, n0, _CLBR,
    0,
    [_lBN, _iP, _hCP, _cN, _cDN, _cAN, _ta, _iAT, _tPN],
    [0, 1, 0, 0, 0, 64 | 0, () => TagList, 0, 0], 2
];
export var CreateLoadBalancerResult$ = [3, n0, _CLBRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateLoadBalancerTlsCertificateRequest$ = [3, n0, _CLBTCR,
    0,
    [_lBN, _cN, _cDN, _cAN, _ta],
    [0, 0, 0, 64 | 0, () => TagList], 3
];
export var CreateLoadBalancerTlsCertificateResult$ = [3, n0, _CLBTCRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateRelationalDatabaseFromSnapshotRequest$ = [3, n0, _CRDFSR,
    0,
    [_rDN, _aZ, _pAu, _rDSN, _rDBI, _sRDN, _rTe, _uLRT, _ta],
    [0, 0, 2, 0, 0, 0, 4, 2, () => TagList], 1
];
export var CreateRelationalDatabaseFromSnapshotResult$ = [3, n0, _CRDFSRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateRelationalDatabaseRequest$ = [3, n0, _CRDR,
    0,
    [_rDN, _rDBIe, _rDBI, _mDN, _mU, _aZ, _mUP, _pBW, _pMW, _pAu, _ta],
    [0, 0, 0, 0, 0, 0, [() => SensitiveString, 0], 0, 0, 2, () => TagList], 5
];
export var CreateRelationalDatabaseResult$ = [3, n0, _CRDRr,
    0,
    [_o],
    [() => OperationList]
];
export var CreateRelationalDatabaseSnapshotRequest$ = [3, n0, _CRDSR,
    0,
    [_rDN, _rDSN, _ta],
    [0, 0, () => TagList], 2
];
export var CreateRelationalDatabaseSnapshotResult$ = [3, n0, _CRDSRr,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteAlarmRequest$ = [3, n0, _DAR,
    0,
    [_aN],
    [[0, 1]], 1
];
export var DeleteAlarmResult$ = [3, n0, _DARe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteAutoSnapshotRequest$ = [3, n0, _DASR,
    0,
    [_rN, _da],
    [0, 0], 2
];
export var DeleteAutoSnapshotResult$ = [3, n0, _DASRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteBucketAccessKeyRequest$ = [3, n0, _DBAKR,
    0,
    [_bN, _aKI],
    [0, 0], 2
];
export var DeleteBucketAccessKeyResult$ = [3, n0, _DBAKRe,
    0,
    [_o],
    [() => OperationList]
];
...
export var DeleteBucketResult$ = [3, n0, _DBRe,
    0,
    [_o],
    [() => OperationList]
];
...
export var DeleteCertificateResult$ = [3, n0, _DCRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteContactMethodRequest$ = [3, n0, _DCMR,
    0,
    [_pro],
    [0], 1
];
export var DeleteContactMethodResult$ = [3, n0, _DCMRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteContainerImageRequest$ = [3, n0, _DCIR,
    0,
    [_sN, _im],
    [[0, 1], [0, 1]], 2
];
export var DeleteContainerImageResult$ = [3, n0, _DCIRe,
    0,
    [],
    []
];
export var DeleteContainerServiceRequest$ = [3, n0, _DCSR,
    0,
    [_sN],
    [[0, 1]], 1
];
export var DeleteContainerServiceResult$ = [3, n0, _DCSRe,
    0,
    [],
    []
];
export var DeleteDiskRequest$ = [3, n0, _DDR,
    0,
    [_dNi, _fDAO],
    [0, 2], 1
];
export var DeleteDiskResult$ = [3, n0, _DDRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteDiskSnapshotRequest$ = [3, n0, _DDSR,
    0,
    [_dSN],
    [0], 1
];
export var DeleteDiskSnapshotResult$ = [3, n0, _DDSRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteDistributionRequest$ = [3, n0, _DDRel,
    0,
    [_dN],
    [0]
];
export var DeleteDistributionResult$ = [3, n0, _DDRele,
    0,
    [_op],
    [() => Operation$]
];
export var DeleteDomainEntryRequest$ = [3, n0, _DDER,
    0,
    [_dNo, _dE],
    [0, () => DomainEntry$], 2
];
export var DeleteDomainEntryResult$ = [3, n0, _DDERe,
    0,
    [_op],
    [() => Operation$]
];
export var DeleteDomainRequest$ = [3, n0, _DDRelet,
    0,
    [_dNo],
    [0], 1
];
export var DeleteDomainResult$ = [3, n0, _DDRelete,
    0,
    [_op],
    [() => Operation$]
];
...
export var DeleteInstanceResult$ = [3, n0, _DIRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteInstanceSnapshotRequest$ = [3, n0, _DISR,
    0,
    [_iSN],
    [0], 1
];
export var DeleteInstanceSnapshotResult$ = [3, n0, _DISRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteKeyPairRequest$ = [3, n0, _DKPR,
    0,
    [_kPN, _eF],
    [0, 0], 1
];
export var DeleteKeyPairResult$ = [3, n0, _DKPRe,
    0,
    [_op],
    [() => Operation$]
];
export var DeleteKnownHostKeysRequest$ = [3, n0, _DKHKR,
    0,
    [_iN],
    [0], 1
];
export var DeleteKnownHostKeysResult$ = [3, n0, _DKHKRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteLoadBalancerRequest$ = [3, n0, _DLBR,
    0,
    [_lBN],
    [0], 1
];
export var DeleteLoadBalancerResult$ = [3, n0, _DLBRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteLoadBalancerTlsCertificateRequest$ = [3, n0, _DLBTCR,
    0,
    [_lBN, _cN, _f],
    [0, 0, 2], 2
];
export var DeleteLoadBalancerTlsCertificateResult$ = [3, n0, _DLBTCRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteRelationalDatabaseRequest$ = [3, n0, _DRDR,
    0,
    [_rDN, _sFS, _fRDSN],
    [0, 2, 0], 1
];
export var DeleteRelationalDatabaseResult$ = [3, n0, _DRDRe,
    0,
    [_o],
    [() => OperationList]
];
export var DeleteRelationalDatabaseSnapshotRequest$ = [3, n0, _DRDSR,
    0,
    [_rDSN],
    [0], 1
];
export var DeleteRelationalDatabaseSnapshotResult$ = [3, n0, _DRDSRe,
    0,
    [_o],
    [() => OperationList]
];
export var DestinationInfo$ = [3, n0, _DI,
    0,
    [_i, _ser],
    [0, 0]
];
export var DetachCertificateFromDistributionRequest$ = [3, n0, _DCFDR,
    0,
    [_dN],
    [0], 1
];
export var DetachCertificateFromDistributionResult$ = [3, n0, _DCFDRe,
    0,
    [_op],
    [() => Operation$]
];
export var DetachDiskRequest$ = [3, n0, _DDRet,
    0,
    [_dNi],
    [0], 1
];
export var DetachDiskResult$ = [3, n0, _DDReta,
    0,
    [_o],
    [() => OperationList]
];
export var DetachInstancesFromLoadBalancerRequest$ = [3, n0, _DIFLBR,
    0,
    [_lBN, _iNn],
    [0, 64 | 0], 2
];
export var DetachInstancesFromLoadBalancerResult$ = [3, n0, _DIFLBRe,
    0,
    [_o],
    [() => OperationList]
];
export var DetachStaticIpRequest$ = [3, n0, _DSIR,
    0,
    [_sIN],
    [0], 1
];
export var DetachStaticIpResult$ = [3, n0, _DSIRe,
    0,
    [_o],
    [() => OperationList]
];
export var DisableAddOnRequest$ = [3, n0, _DAOR,
    0,
    [_aOT, _rN],
    [0, 0], 2
];
export var DisableAddOnResult$ = [3, n0, _DAORi,
    0,
    [_o],
    [() => OperationList]
];
...
export var DiskInfo$ = [3, n0, _DIi,
    0,
    [_n, _pa, _sIG, _iSD],
    [0, 0, 1, 2]
];
export var DiskMap$ = [3, n0, _DM,
    0,
    [_oDP, _nDN],
    [0, 0]
];
export var DiskSnapshot$ = [3, n0, _DS,
    0,
    [_n, _a, _sC, _cA, _l, _rT, _ta, _sIG, _stat, _prog, _fDN, _fDA, _fIN, _fIA, _iFAS],
    [0, 0, 0, 4, () => ResourceLocation$, 0, () => TagList, 1, 0, 0, 0, 0, 0, 0, 2]
];
export var DiskSnapshotInfo$ = [3, n0, _DSI,
    0,
    [_sIG],
    [1]
];
export var DistributionBundle$ = [3, n0, _DB,
    0,
    [_bIu, _n, _pri, _tPMIG, _iA],
    [0, 0, 1, 1, 2]
];
export var DnsRecordCreationState$ = [3, n0, _DRCS,
    0,
    [_co, _m],
    [0, 0]
];
...
export var DomainEntry$ = [3, n0, _DE,
    0,
    [_i, _n, _tar, _iAsl, _ty, _opti],
    [0, 0, 0, 2, 0, 128 | 0]
];
export var DomainValidationRecord$ = [3, n0, _DVR,
    0,
    [_dNo, _rRe, _dRCS, _vS],
    [0, () => ResourceRecord$, () => DnsRecordCreationState$, 0]
];
export var DownloadDefaultKeyPairRequest$ = [3, n0, _DDKPR,
    0,
    [],
    []
];
export var DownloadDefaultKeyPairResult$ = [3, n0, _DDKPRo,
    0,
    [_pKB, _pKBr, _cA],
    [0, 0, 4]
];
export var EnableAddOnRequest$ = [3, n0, _EAOR,
    0,
    [_rN, _aOR],
    [0, () => AddOnRequest$], 2
];
export var EnableAddOnResult$ = [3, n0, _EAORn,
    0,
    [_o],
    [() => OperationList]
];
export var EndpointRequest$ = [3, n0, _ER,
    0,
    [_cNo, _cPo, _hC],
    [0, 1, () => ContainerServiceHealthCheckConfig$], 2
];
export var EstimateByTime$ = [3, n0, _EBT,
    0,
    [_uC, _pUr, _u, _cu, _tP],
    [1, 0, 1, 0, () => TimePeriod$]
];
export var ExportSnapshotRecord$ = [3, n0, _ESR,
    0,
    [_n, _a, _cA, _l, _rT, _stat, _sI, _dI],
    [0, 0, 4, () => ResourceLocation$, 0, 0, () => ExportSnapshotRecordSourceInfo$, () => DestinationInfo$]
];
export var ExportSnapshotRecordSourceInfo$ = [3, n0, _ESRSI,
    0,
    [_rT, _cA, _n, _a, _fRN, _fRA, _iSI, _dSI],
    [0, 4, 0, 0, 0, 0, () => InstanceSnapshotInfo$, () => DiskSnapshotInfo$]
];
export var ExportSnapshotRequest$ = [3, n0, _ESRx,
    0,
    [_sSN],
    [0], 1
];
export var ExportSnapshotResult$ = [3, n0, _ESRxp,
    0,
    [_o],
    [() => OperationList]
];
export var GetActiveNamesRequest$ = [3, n0, _GANR,
    0,
    [_pT],
    [0]
];
export var GetActiveNamesResult$ = [3, n0, _GANRe,
    0,
    [_aNc, _nPT],
    [64 | 0, 0]
];
export var GetAlarmsRequest$ = [3, n0, _GAR,
    0,
    [_aN, _pT, _mRN],
    [[0, { [_hQ]: _aN }], [0, { [_hQ]: _pT }], [0, { [_hQ]: _mRN }]]
];
export var GetAlarmsResult$ = [3, n0, _GARe,
    0,
    [_al, _nPT],
    [() => AlarmsList, 0]
];
export var GetAutoSnapshotsRequest$ = [3, n0, _GASR,
    0,
    [_rN],
    [0], 1
];
export var GetAutoSnapshotsResult$ = [3, n0, _GASRe,
    0,
    [_rN, _rT, _aSu],
    [0, 0, () => AutoSnapshotDetailsList]
];
export var GetBlueprintsRequest$ = [3, n0, _GBR,
    0,
    [_iI, _pT, _aC],
    [2, 0, 0]
];
export var GetBlueprintsResult$ = [3, n0, _GBRe,
    0,
    [_bl, _nPT],
    [() => BlueprintList, 0]
];
export var GetBucketAccessKeysRequest$ = [3, n0, _GBAKR,
    0,
    [_bN],
    [0], 1
];
export var GetBucketAccessKeysResult$ = [3, n0, _GBAKRe,
    0,
    [_aKc],
    [[() => AccessKeyList, 0]]
];
export var GetBucketBundlesRequest$ = [3, n0, _GBBR,
    0,
    [_iI],
    [2]
];
export var GetBucketBundlesResult$ = [3, n0, _GBBRe,
    0,
    [_bun],
    [() => BucketBundleList]
];
export var GetBucketMetricDataRequest$ = [3, n0, _GBMDR,
    0,
    [_bN, _mN, _sT, _eT, _p, _stati, _u],
    [0, 0, 4, 4, 1, 64 | 0, 0], 7
];
export var GetBucketMetricDataResult$ = [3, n0, _GBMDRe,
    0,
    [_mN, _mD],
    [0, () => MetricDatapointList]
];
export var GetBucketsRequest$ = [3, n0, _GBRet,
    0,
    [_bN, _pT, _iCR, _iC],
    [0, 0, 2, 2]
];
export var GetBucketsResult$ = [3, n0, _GBRetu,
    0,
    [_buc, _nPT, _aLBS],
    [() => BucketList, 0, () => AccountLevelBpaSync$]
];
export var GetBundlesRequest$ = [3, n0, _GBRetun,
    0,
    [_iI, _pT, _aC],
    [2, 0, 0]
];
export var GetBundlesResult$ = [3, n0, _GBRetund,
    0,
    [_bun, _nPT],
    [() => BundleList, 0]
];
export var GetCertificatesRequest$ = [3, n0, _GCR,
    0,
    [_cSe, _iCD, _cN, _pT],
    [64 | 0, 2, 0, 0]
];
export var GetCertificatesResult$ = [3, n0, _GCRe,
    0,
    [_cer, _nPT],
    [() => CertificateSummaryList, 0]
];
export var GetCloudFormationStackRecordsRequest$ = [3, n0, _GCFSRR,
    0,
    [_pT],
    [0]
];
export var GetCloudFormationStackRecordsResult$ = [3, n0, _GCFSRRe,
    0,
    [_cFSR, _nPT],
    [() => CloudFormationStackRecordList, 0]
];
export var GetContactMethodsRequest$ = [3, n0, _GCMR,
    0,
    [_prot],
    [[64 | 0, { [_hQ]: _prot }]]
];
export var GetContactMethodsResult$ = [3, n0, _GCMRe,
    0,
    [_cM],
    [() => ContactMethodsList]
];
export var GetContainerAPIMetadataRequest$ = [3, n0, _GCAPIMR,
    0,
    [],
    []
];
export var GetContainerAPIMetadataResult$ = [3, n0, _GCAPIMRe,
    0,
    [_me],
    [[1, n0, _CSMEL, 0, 128 | 0]]
];
export var GetContainerImagesRequest$ = [3, n0, _GCIR,
    0,
    [_sN],
    [[0, 1]], 1
];
export var GetContainerImagesResult$ = [3, n0, _GCIRe,
    0,
    [_cI],
    [() => ContainerImageList]
];
export var GetContainerLogRequest$ = [3, n0, _GCLR,
    0,
    [_sN, _cNo, _sT, _eT, _fP, _pT],
    [[0, 1], [0, 1], [4, { [_hQ]: _sT }], [4, { [_hQ]: _eT }], [0, { [_hQ]: _fP }], [0, { [_hQ]: _pT }]], 2
];
export var GetContainerLogResult$ = [3, n0, _GCLRe,
    0,
    [_lE, _nPT],
    [() => ContainerServiceLogEventList, 0]
];
export var GetContainerServiceDeploymentsRequest$ = [3, n0, _GCSDR,
    0,
    [_sN],
    [[0, 1]], 1
];
export var GetContainerServiceDeploymentsResult$ = [3, n0, _GCSDRe,
    0,
    [_depl],
    [() => ContainerServiceDeploymentList]
];
export var GetContainerServiceMetricDataRequest$ = [3, n0, _GCSMDR,
    0,
    [_sN, _mN, _sT, _eT, _p, _stati],
    [[0, 1], [0, { [_hQ]: _mN }], [4, { [_hQ]: _sT }], [4, { [_hQ]: _eT }], [1, { [_hQ]: _p }], [64 | 0, { [_hQ]: _stati }]], 6
];
export var GetContainerServiceMetricDataResult$ = [3, n0, _GCSMDRe,
    0,
    [_mN, _mD],
    [0, () => MetricDatapointList]
];
export var GetContainerServicePowersRequest$ = [3, n0, _GCSPR,
    0,
    [],
    []
];
export var GetContainerServicePowersResult$ = [3, n0, _GCSPRe,
    0,
    [_pow],
    [() => ContainerServicePowerList]
];
export var GetContainerServicesRequest$ = [3, n0, _GCSR,
    0,
    [_sN],
    [[0, { [_hQ]: _sN }]]
];
export var GetCostEstimateRequest$ = [3, n0, _GCER,
    0,
    [_rN, _sT, _eT],
    [0, 4, 4], 3
];
export var GetCostEstimateResult$ = [3, n0, _GCERe,
    0,
    [_rBE],
    [() => ResourcesBudgetEstimate]
];
export var GetDiskRequest$ = [3, n0, _GDR,
    0,
    [_dNi],
    [0], 1
];
export var GetDiskResult$ = [3, n0, _GDRe,
    0,
    [_disk],
    [() => Disk$]
];
export var GetDiskSnapshotRequest$ = [3, n0, _GDSR,
    0,
    [_dSN],
    [0], 1
];
export var GetDiskSnapshotResult$ = [3, n0, _GDSRe,
    0,
    [_dS],
    [() => DiskSnapshot$]
];
export var GetDiskSnapshotsRequest$ = [3, n0, _GDSRet,
    0,
    [_pT],
    [0]
];
export var GetDiskSnapshotsResult$ = [3, n0, _GDSReti,
    0,
    [_dSi, _nPT],
    [() => DiskSnapshotList, 0]
];
export var GetDisksRequest$ = [3, n0, _GDRet,
    0,
    [_pT],
    [0]
];
export var GetDisksResult$ = [3, n0, _GDReti,
    0,
    [_disks, _nPT],
    [() => DiskList, 0]
];
export var GetDistributionBundlesRequest$ = [3, n0, _GDBR,
    0,
    [],
    []
];
export var GetDistributionBundlesResult$ = [3, n0, _GDBRe,
    0,
    [_bun],
    [() => DistributionBundleList]
];
export var GetDistributionLatestCacheResetRequest$ = [3, n0, _GDLCRR,
    0,
    [_dN],
    [0]
];
export var GetDistributionLatestCacheResetResult$ = [3, n0, _GDLCRRe,
    0,
    [_st, _cT],
    [0, 4]
];
export var GetDistributionMetricDataRequest$ = [3, n0, _GDMDR,
    0,
    [_dN, _mN, _sT, _eT, _p, _u, _stati],
    [0, 0, 4, 4, 1, 0, 64 | 0], 7
];
export var GetDistributionMetricDataResult$ = [3, n0, _GDMDRe,
    0,
    [_mN, _mD],
    [0, () => MetricDatapointList]
];
export var GetDistributionsRequest$ = [3, n0, _GDRetis,
    0,
    [_dN, _pT],
    [0, 0]
];
export var GetDistributionsResult$ = [3, n0, _GDRetist,
    0,
    [_dist, _nPT],
    [() => DistributionList, 0]
];
export var GetDomainRequest$ = [3, n0, _GDReto,
    0,
    [_dNo],
    [0], 1
];
export var GetDomainResult$ = [3, n0, _GDRetom,
    0,
    [_do],
    [() => Domain$]
];
export var GetDomainsRequest$ = [3, n0, _GDRetoma,
    0,
    [_pT],
    [0]
];
export var GetDomainsResult$ = [3, n0, _GDRetomai,
    0,
    [_dom, _nPT],
    [() => DomainList, 0]
];
export var GetExportSnapshotRecordsRequest$ = [3, n0, _GESRR,
    0,
    [_pT],
    [0]
];
export var GetExportSnapshotRecordsResult$ = [3, n0, _GESRRe,
    0,
    [_eSR, _nPT],
    [() => ExportSnapshotRecordList, 0]
];
export var GetInstanceAccessDetailsRequest$ = [3, n0, _GIADR,
    0,
    [_iN, _pro],
    [0, 0], 1
];
export var GetInstanceAccessDetailsResult$ = [3, n0, _GIADRe,
    0,
    [_aD],
    [() => InstanceAccessDetails$]
];
export var GetInstanceMetricDataRequest$ = [3, n0, _GIMDR,
    0,
    [_iN, _mN, _p, _sT, _eT, _u, _stati],
    [0, 0, 1, 4, 4, 0, 64 | 0], 7
];
export var GetInstanceMetricDataResult$ = [3, n0, _GIMDRe,
    0,
    [_mN, _mD],
    [0, () => MetricDatapointList]
];
export var GetInstancePortStatesRequest$ = [3, n0, _GIPSR,
    0,
    [_iN],
    [0], 1
];
export var GetInstancePortStatesResult$ = [3, n0, _GIPSRe,
    0,
    [_pS],
...
export var GetInstanceResult$ = [3, n0, _GIRe,
    0,
    [_ins],
    [() => Instance$]
];
export var GetInstanceSnapshotRequest$ = [3, n0, _GISR,
    0,
    [_iSN],
    [0], 1
];
export var GetInstanceSnapshotResult$ = [3, n0, _GISRe,
    0,
    [_iSn],
    [() => InstanceSnapshot$]
];
export var GetInstanceSnapshotsRequest$ = [3, n0, _GISRet,
    0,
    [_pT],
    [0]
];
export var GetInstanceSnapshotsResult$ = [3, n0, _GISRetn,
    0,
    [_iSns, _nPT],
    [() => InstanceSnapshotList, 0]
];
export var GetInstancesRequest$ = [3, n0, _GIRet,
    0,
    [_pT],
    [0]
];
export var GetInstancesResult$ = [3, n0, _GIRetn,
    0,
    [_in, _nPT],
    [() => InstanceList, 0]
];
export var GetInstanceStateRequest$ = [3, n0, _GISRetns,
    0,
    [_iN],
    [0], 1
];
export var GetInstanceStateResult$ = [3, n0, _GISRetnst,
    0,
    [_stat],
    [() => InstanceState$]
];
export var GetKeyPairRequest$ = [3, n0, _GKPR,
    0,
    [_kPN],
    [0], 1
];
export var GetKeyPairResult$ = [3, n0, _GKPRe,
    0,
    [_kP],
    [() => KeyPair$]
];
export var GetKeyPairsRequest$ = [3, n0, _GKPRet,
    0,
    [_pT, _iDKP],
    [0, 2]
];
export var GetKeyPairsResult$ = [3, n0, _GKPRete,
    0,
    [_kPe, _nPT],
    [() => KeyPairList, 0]
];
export var GetLoadBalancerMetricDataRequest$ = [3, n0, _GLBMDR,
    0,
    [_lBN, _mN, _p, _sT, _eT, _u, _stati],
    [0, 0, 1, 4, 4, 0, 64 | 0], 7
];
export var GetLoadBalancerMetricDataResult$ = [3, n0, _GLBMDRe,
    0,
    [_mN, _mD],
    [0, () => MetricDatapointList]
];
export var GetLoadBalancerRequest$ = [3, n0, _GLBR,
    0,
    [_lBN],
    [0], 1
];
export var GetLoadBalancerResult$ = [3, n0, _GLBRe,
    0,
    [_lB],
    [() => LoadBalancer$]
];
export var GetLoadBalancersRequest$ = [3, n0, _GLBRet,
    0,
    [_pT],
    [0]
];
export var GetLoadBalancersResult$ = [3, n0, _GLBReto,
    0,
    [_lBo, _nPT],
    [() => LoadBalancerList, 0]
];
export var GetLoadBalancerTlsCertificatesRequest$ = [3, n0, _GLBTCR,
    0,
    [_lBN],
    [0], 1
];
export var GetLoadBalancerTlsCertificatesResult$ = [3, n0, _GLBTCRe,
    0,
    [_tC],
    [() => LoadBalancerTlsCertificateList]
];
export var GetLoadBalancerTlsPoliciesRequest$ = [3, n0, _GLBTPR,
    0,
    [_pT],
    [0]
];
export var GetLoadBalancerTlsPoliciesResult$ = [3, n0, _GLBTPRe,
    0,
    [_tPl, _nPT],
...
export var GetOperationResult$ = [3, n0, _GORe,
    0,
    [_op],
    [() => Operation$]
];
export var GetOperationsForResourceRequest$ = [3, n0, _GOFRR,
    0,
    [_rN, _pT],
    [0, 0], 1
];
export var GetOperationsForResourceResult$ = [3, n0, _GOFRRe,
    0,
    [_o, _nPC, _nPT],
    [() => OperationList, 0, 0]
];
export var GetOperationsRequest$ = [3, n0, _GORet,
    0,
    [_pT],
    [0]
];
export var GetOperationsResult$ = [3, n0, _GORetp,
    0,
    [_o, _nPT],
    [() => OperationList, 0]
];
export var GetRegionsRequest$ = [3, n0, _GRR,
    0,
    [_iAZ, _iRDAZ],
    [2, 2]
];
export var GetRegionsResult$ = [3, n0, _GRRe,
    0,
    [_reg],
    [() => RegionList]
];
export var GetRelationalDatabaseBlueprintsRequest$ = [3, n0, _GRDBR,
    0,
    [_pT],
    [0]
];
export var GetRelationalDatabaseBlueprintsResult$ = [3, n0, _GRDBRe,
    0,
    [_bl, _nPT],
    [() => RelationalDatabaseBlueprintList, 0]
];
export var GetRelationalDatabaseBundlesRequest$ = [3, n0, _GRDBRet,
    0,
    [_pT, _iI],
    [0, 2]
];
export var GetRelationalDatabaseBundlesResult$ = [3, n0, _GRDBRete,
    0,
    [_bun, _nPT],
    [() => RelationalDatabaseBundleList, 0]
];
export var GetRelationalDatabaseEventsRequest$ = [3, n0, _GRDER,
    0,
    [_rDN, _dIM, _pT],
    [0, 1, 0], 1
];
export var GetRelationalDatabaseEventsResult$ = [3, n0, _GRDERe,
    0,
    [_rDE, _nPT],
    [() => RelationalDatabaseEventList, 0]
];
export var GetRelationalDatabaseLogEventsRequest$ = [3, n0, _GRDLER,
    0,
    [_rDN, _lSN, _sT, _eT, _sFH, _pT],
    [0, 0, 4, 4, 2, 0], 2
];
export var GetRelationalDatabaseLogEventsResult$ = [3, n0, _GRDLERe,
    0,
    [_rLE, _nBT, _nFT],
    [() => LogEventList, 0, 0]
];
export var GetRelationalDatabaseLogStreamsRequest$ = [3, n0, _GRDLSR,
    0,
    [_rDN],
    [0], 1
];
export var GetRelationalDatabaseLogStreamsResult$ = [3, n0, _GRDLSRe,
    0,
    [_lS],
    [64 | 0]
];
export var GetRelationalDatabaseMasterUserPasswordRequest$ = [3, n0, _GRDMUPR,
    0,
    [_rDN, _pV],
    [0, 0], 1
];
export var GetRelationalDatabaseMasterUserPasswordResult$ = [3, n0, _GRDMUPRe,
    0,
    [_mUP, _cA],
    [[() => SensitiveString, 0], 4]
];
export var GetRelationalDatabaseMetricDataRequest$ = [3, n0, _GRDMDR,
    0,
    [_rDN, _mN, _p, _sT, _eT, _u, _stati],
    [0, 0, 1, 4, 4, 0, 64 | 0], 7
];
export var GetRelationalDatabaseMetricDataResult$ = [3, n0, _GRDMDRe,
    0,
    [_mN, _mD],
    [0, () => MetricDatapointList]
];
export var GetRelationalDatabaseParametersRequest$ = [3, n0, _GRDPR,
    0,
    [_rDN, _pT],
    [0, 0], 1
];
export var GetRelationalDatabaseParametersResult$ = [3, n0, _GRDPRe,
    0,
    [_par, _nPT],
    [() => RelationalDatabaseParameterList, 0]
];
export var GetRelationalDatabaseRequest$ = [3, n0, _GRDR,
    0,
    [_rDN],
    [0], 1
];
export var GetRelationalDatabaseResult$ = [3, n0, _GRDRe,
    0,
    [_rDe],
    [() => RelationalDatabase$]
];
export var GetRelationalDatabaseSnapshotRequest$ = [3, n0, _GRDSR,
    0,
    [_rDSN],
    [0], 1
];
export var GetRelationalDatabaseSnapshotResult$ = [3, n0, _GRDSRe,
    0,
    [_rDS],
    [() => RelationalDatabaseSnapshot$]
];
export var GetRelationalDatabaseSnapshotsRequest$ = [3, n0, _GRDSRet,
    0,
    [_pT],
    [0]
];
export var GetRelationalDatabaseSnapshotsResult$ = [3, n0, _GRDSRete,
    0,
    [_rDSe, _nPT],
    [() => RelationalDatabaseSnapshotList, 0]
];
export var GetRelationalDatabasesRequest$ = [3, n0, _GRDRet,
    0,
    [_pT],
    [0]
];
export var GetRelationalDatabasesResult$ = [3, n0, _GRDRete,
    0,
    [_rDel, _nPT],
    [() => RelationalDatabaseList, 0]
];
export var GetSetupHistoryRequest$ = [3, n0, _GSHR,
    0,
    [_rN, _pT],
    [0, 0], 1
];
export var GetSetupHistoryResult$ = [3, n0, _GSHRe,
    0,
    [_sH, _nPT],
    [() => setupHistoryList, 0]
];
export var GetStaticIpRequest$ = [3, n0, _GSIR,
    0,
    [_sIN],
    [0], 1
];
export var GetStaticIpResult$ = [3, n0, _GSIRe,
    0,
    [_sIt],
    [() => StaticIp$]
];
export var GetStaticIpsRequest$ = [3, n0, _GSIRet,
    0,
    [_pT],
    [0]
];
export var GetStaticIpsResult$ = [3, n0, _GSIRett,
    0,
    [_sIta, _nPT],
    [() => StaticIpList, 0]
];
export var HeaderObject$ = [3, n0, _HO,
    0,
    [_opt, _hAL],
    [0, 64 | 0]
];
export var HostKeyAttributes$ = [3, n0, _HKA,
    0,
    [_alg, _pK, _wA, _fSHA, _fSHAi, _nVB, _nVA],
    [0, 0, 4, 0, 0, 4, 4]
];
export var ImportKeyPairRequest$ = [3, n0, _IKPR,
    0,
    [_kPN, _pKB],
    [0, 0], 2
];
export var ImportKeyPairResult$ = [3, n0, _IKPRm,
    0,
    [_op],
    [() => Operation$]
];
...
export var InstanceSnapshotInfo$ = [3, n0, _ISI,
    0,
    [_fBIr, _fBI, _fDI],
    [0, 0, () => DiskInfoList]
];
...
export var IsVpcPeeredRequest$ = [3, n0, _IVPR,
    0,
    [],
    []
];
export var IsVpcPeeredResult$ = [3, n0, _IVPRs,
    0,
    [_iPs],
    [2]
];
...
export var LightsailDistribution$ = [3, n0, _LD,
    0,
...
export var LoadBalancerTlsCertificate$ = [3, n0, _LBTC,
    0,
...
export var LoadBalancerTlsCertificateDnsRecordCreationState$ = [3, n0, _LBTCDRCS,
    0,
    [_co, _m],
    [0, 0]
];
export var LoadBalancerTlsCertificateDomainValidationOption$ = [3, n0, _LBTCDVO,
    0,
    [_dNo, _vS],
    [0, 0]
];
export var LoadBalancerTlsCertificateDomainValidationRecord$ = [3, n0, _LBTCDVR,
    0,
    [_n, _ty, _va, _vS, _dNo, _dRCS],
    [0, 0, 0, 0, 0, () => LoadBalancerTlsCertificateDnsRecordCreationState$]
];
export var LoadBalancerTlsCertificateRenewalSummary$ = [3, n0, _LBTCRS,
    0,
    [_rSe, _dVO],
    [0, () => LoadBalancerTlsCertificateDomainValidationOptionList]
];
export var LoadBalancerTlsCertificateSummary$ = [3, n0, _LBTCS,
    0,
    [_n, _iAst],
    [0, 2]
];
export var LoadBalancerTlsPolicy$ = [3, n0, _LBTP,
    0,
...
export var MetricDatapoint$ = [3, n0, _MD,
    0,
    [_av, _ma, _mi, _sCa, _sum, _ti, _u],
    [1, 1, 1, 1, 1, 4, 0]
];
export var MonitoredResourceInfo$ = [3, n0, _MRI,
    0,
    [_a, _n, _rT],
    [0, 0, 0]
];
export var MonthlyTransfer$ = [3, n0, _MT,
    0,
    [_gPMA],
    [1]
];
export var NameServersUpdateState$ = [3, n0, _NSUS,
    0,
    [_co, _m],
    [0, 0]
];
export var OpenInstancePublicPortsRequest$ = [3, n0, _OIPPR,
    0,
    [_pI, _iN],
    [() => PortInfo$, 0], 2
];
export var OpenInstancePublicPortsResult$ = [3, n0, _OIPPRp,
    0,
    [_op],
    [() => Operation$]
];
...
export var PeerVpcRequest$ = [3, n0, _PVR,
    0,
    [],
    []
];
export var PeerVpcResult$ = [3, n0, _PVRe,
    0,
    [_op],
    [() => Operation$]
];
...
export var PendingModifiedRelationalDatabaseValues$ = [3, n0, _PMRDV,
    0,
    [_mUP, _eV, _bRE],
    [0, 0, 2]
];
export var PortInfo$ = [3, n0, _PI,
    0,
    [_fPr, _tPo, _pro, _ci, _iCp, _cLA],
    [1, 1, 0, 64 | 0, 64 | 0, 64 | 0]
];
export var PrivateRegistryAccess$ = [3, n0, _PRA,
    0,
    [_eIPR],
    [() => ContainerServiceECRImagePullerRole$]
];
export var PrivateRegistryAccessRequest$ = [3, n0, _PRAR,
    0,
    [_eIPR],
...
export var PutInstancePublicPortsRequest$ = [3, n0, _PIPPR,
    0,
    [_pIor, _iN],
    [() => PortInfoList, 0], 2
];
export var PutInstancePublicPortsResult$ = [3, n0, _PIPPRu,
    0,
    [_op],
    [() => Operation$]
];
export var QueryStringObject$ = [3, n0, _QSO,
    0,
    [_opt, _qSAL],
    [2, 64 | 0]
];
export var R53HostedZoneDeletionState$ = [3, n0, _RHZDS,
    0,
    [_co, _m],
    [0, 0]
];
export var RebootInstanceRequest$ = [3, n0, _RIR,
    0,
    [_iN],
    [0], 1
];
export var RebootInstanceResult$ = [3, n0, _RIRe,
    0,
    [_o],
    [() => OperationList]
];
export var RebootRelationalDatabaseRequest$ = [3, n0, _RRDR,
    0,
    [_rDN],
    [0], 1
];
export var RebootRelationalDatabaseResult$ = [3, n0, _RRDRe,
    0,
    [_o],
    [() => OperationList]
];
...
export var RegisterContainerImageRequest$ = [3, n0, _RCIR,
    0,
    [_sN, _la, _di],
    [[0, 1], 0, 0], 3
];
export var RegisterContainerImageResult$ = [3, n0, _RCIRe,
    0,
    [_cIo],
    [() => ContainerImage$]
];
export var RegisteredDomainDelegationInfo$ = [3, n0, _RDDI,
    0,
    [_nSUS, _rHZDS],
    [() => NameServersUpdateState$, () => R53HostedZoneDeletionState$]
];
export var RelationalDatabase$ = [3, n0, _RD,
    0,
...
export var RelationalDatabaseBlueprint$ = [3, n0, _RDB,
    0,
    [_bI, _eng, _eV, _eDn, _eVD, _iED],
    [0, 0, 0, 0, 0, 2]
];
export var RelationalDatabaseBundle$ = [3, n0, _RDBe,
    0,
    [_bIu, _n, _pri, _rSIG, _dSIG, _tPMIG, _cC, _iEs, _iA],
    [0, 0, 1, 1, 1, 1, 1, 2, 2]
];
export var RelationalDatabaseEndpoint$ = [3, n0, _RDE,
    0,
    [_port, _ad],
    [1, 0]
];
export var RelationalDatabaseEvent$ = [3, n0, _RDEe,
    0,
    [_res, _cA, _m, _eCv],
    [0, 4, 0, 64 | 0]
];
export var RelationalDatabaseHardware$ = [3, n0, _RDH,
    0,
    [_cC, _dSIG, _rSIG],
    [1, 1, 1]
];
export var RelationalDatabaseParameter$ = [3, n0, _RDP,
    0,
    [_aV, _aMp, _aTp, _dT, _de, _iM, _pN, _pVa],
    [0, 0, 0, 0, 0, 2, 0, 0]
];
export var RelationalDatabaseSnapshot$ = [3, n0, _RDS,
    0,
...
export var ReleaseStaticIpRequest$ = [3, n0, _RSIR,
    0,
    [_sIN],
    [0], 1
];
export var ReleaseStaticIpResult$ = [3, n0, _RSIRe,
    0,
    [_o],
    [() => OperationList]
];
...
export var ResetDistributionCacheRequest$ = [3, n0, _RDCR,
    0,
    [_dN],
    [0]
];
export var ResetDistributionCacheResult$ = [3, n0, _RDCRe,
    0,
    [_st, _cT, _op],
    [0, 4, () => Operation$]
];
export var ResourceBudgetEstimate$ = [3, n0, _RBE,
    0,
    [_rN, _rT, _cEo, _sT, _eT],
    [0, 0, () => CostEstimates, 4, 4]
];
export var ResourceLocation$ = [3, n0, _RL,
    0,
    [_aZ, _rNe],
    [0, 0]
];
export var ResourceReceivingAccess$ = [3, n0, _RRA,
    0,
    [_n, _rT],
    [0, 0]
];
...
export var SendContactMethodVerificationRequest$ = [3, n0, _SCMVR,
    0,
    [_pro],
    [0], 1
];
export var SendContactMethodVerificationResult$ = [3, n0, _SCMVRe,
    0,
    [_o],
    [() => OperationList]
];
...
export var SetIpAddressTypeRequest$ = [3, n0, _SIATR,
    0,
    [_rT, _rN, _iAT, _aBU],
    [0, 0, 0, 2], 3
];
export var SetIpAddressTypeResult$ = [3, n0, _SIATRe,
    0,
    [_o],
    [() => OperationList]
];
export var SetResourceAccessForBucketRequest$ = [3, n0, _SRAFBR,
    0,
    [_rN, _bN, _acc],
    [0, 0, 0], 3
];
export var SetResourceAccessForBucketResult$ = [3, n0, _SRAFBRe,
    0,
    [_o],
    [() => OperationList]
];
export var SetupExecutionDetails$ = [3, n0, _SED,
    0,
    [_com, _dTa, _n, _st, _sE, _sO, _v],
    [0, 4, 0, 0, 0, 0, 0]
];
export var SetupHistory$ = [3, n0, _SH,
    0,
    [_oI, _req, _res, _eDx, _st],
    [0, () => SetupRequest$, () => SetupHistoryResource$, () => SetupExecutionDetailsList, 0]
];
export var SetupHistoryResource$ = [3, n0, _SHR,
    0,
    [_n, _a, _cA, _l, _rT],
    [0, 0, 4, () => ResourceLocation$, 0]
];
export var SetupInstanceHttpsRequest$ = [3, n0, _SIHR,
    0,
    [_iN, _eAm, _dNom, _cPe],
    [0, [() => EmailAddress, 0], 64 | 0, 0], 4
];
export var SetupInstanceHttpsResult$ = [3, n0, _SIHRe,
    0,
    [_o],
    [() => OperationList]
];
export var SetupRequest$ = [3, n0, _SR,
    0,
    [_iN, _dNom, _cPe],
    [0, 64 | 0, 0]
];
export var StartGUISessionRequest$ = [3, n0, _SGUISR,
    0,
    [_rN],
    [0], 1
];
export var StartGUISessionResult$ = [3, n0, _SGUISRt,
    0,
    [_o],
    [() => OperationList]
];
export var StartInstanceRequest$ = [3, n0, _SIR,
    0,
    [_iN],
    [0], 1
];
export var StartInstanceResult$ = [3, n0, _SIRt,
    0,
    [_o],
    [() => OperationList]
];
export var StartRelationalDatabaseRequest$ = [3, n0, _SRDR,
    0,
    [_rDN],
    [0], 1
];
export var StartRelationalDatabaseResult$ = [3, n0, _SRDRt,
    0,
    [_o],
    [() => OperationList]
];
export var StaticIp$ = [3, n0, _SI,
    0,
    [_n, _a, _sC, _cA, _l, _rT, _iApd, _aT, _iAst],
    [0, 0, 0, 4, () => ResourceLocation$, 0, 0, 0, 2]
];
export var StopGUISessionRequest$ = [3, n0, _SGUISRto,
    0,
    [_rN],
    [0], 1
];
export var StopGUISessionResult$ = [3, n0, _SGUISRtop,
    0,
    [_o],
    [() => OperationList]
];
export var StopInstanceOnIdleRequest$ = [3, n0, _SIOIR,
    0,
    [_th, _du],
    [0, 0]
];
export var StopInstanceRequest$ = [3, n0, _SIRto,
    0,
    [_iN, _f],
    [0, 2], 1
];
export var StopInstanceResult$ = [3, n0, _SIRtop,
    0,
    [_o],
    [() => OperationList]
];
export var StopRelationalDatabaseRequest$ = [3, n0, _SRDRto,
    0,
    [_rDN, _rDSN],
    [0, 0], 1
];
export var StopRelationalDatabaseResult$ = [3, n0, _SRDRtop,
    0,
    [_o],
    [() => OperationList]
];
...
export var TestAlarmRequest$ = [3, n0, _TAR,
    0,
    [_aN, _stat],
    [[0, 1], [0, { [_hQ]: _stat }]], 2
];
export var TestAlarmResult$ = [3, n0, _TARe,
    0,
    [_o],
    [() => OperationList]
];
...
export var UnpeerVpcRequest$ = [3, n0, _UVR,
    0,
    [],
    []
];
export var UnpeerVpcResult$ = [3, n0, _UVRn,
    0,
    [_op],
    [() => Operation$]
];
...
export var UpdateBucketBundleRequest$ = [3, n0, _UBBR,
    0,
    [_bN, _bIu],
    [0, 0], 2
];
export var UpdateBucketBundleResult$ = [3, n0, _UBBRp,
    0,
    [_o],
    [() => OperationList]
];
export var UpdateBucketRequest$ = [3, n0, _UBR,
    0,
    [_bN, _aR, _ve, _rAA, _aLC, _cor],
    [0, () => AccessRules$, 0, 64 | 0, () => BucketAccessLogConfig$, () => BucketCorsConfig$], 1
];
export var UpdateBucketResult$ = [3, n0, _UBRp,
    0,
    [_bu, _o],
    [() => Bucket$, () => OperationList]
];
export var UpdateContainerServiceRequest$ = [3, n0, _UCSR,
    0,
    [_sN, _po, _sc, _iD, _pDNu, _pRA],
    [[0, 1], 0, 1, 2, [2, n0, _CSPD, 0, 0, 64 | 0], () => PrivateRegistryAccessRequest$], 1
];
export var UpdateContainerServiceResult$ = [3, n0, _UCSRp,
    0,
    [_cSo],
    [() => ContainerService$]
];
export var UpdateDistributionBundleRequest$ = [3, n0, _UDBR,
    0,
    [_dN, _bIu],
    [0, 0]
];
export var UpdateDistributionBundleResult$ = [3, n0, _UDBRp,
    0,
    [_op],
    [() => Operation$]
];
...
export var UpdateDomainEntryRequest$ = [3, n0, _UDER,
    0,
    [_dNo, _dE],
    [0, () => DomainEntry$], 2
];
export var UpdateDomainEntryResult$ = [3, n0, _UDERp,
    0,
    [_o],
    [() => OperationList]
];
export var UpdateInstanceMetadataOptionsRequest$ = [3, n0, _UIMOR,
    0,
    [_iN, _hTt, _hEt, _hPRHL, _hPI],
    [0, 0, 0, 1, 0], 1
];
export var UpdateInstanceMetadataOptionsResult$ = [3, n0, _UIMORp,
    0,
    [_op],
    [() => Operation$]
];
export var UpdateLoadBalancerAttributeRequest$ = [3, n0, _ULBAR,
    0,
    [_lBN, _aNt, _aVt],
    [0, 0, 0], 3
];
export var UpdateLoadBalancerAttributeResult$ = [3, n0, _ULBARp,
    0,
    [_o],
    [() => OperationList]
];
export var UpdateRelationalDatabaseParametersRequest$ = [3, n0, _URDPR,
    0,
    [_rDN, _par],
    [0, () => RelationalDatabaseParameterList], 2
];
export var UpdateRelationalDatabaseParametersResult$ = [3, n0, _URDPRp,
    0,
    [_o],
    [() => OperationList]
];
export var UpdateRelationalDatabaseRequest$ = [3, n0, _URDR,
    0,
    [_rDN, _mUP, _rMUP, _pBW, _pMW, _eBR, _dBR, _pAu, _aI, _cCI, _rDBIe],
    [0, [() => SensitiveString, 0], 2, 0, 0, 2, 2, 2, 2, 0, 0], 1
];
export var UpdateRelationalDatabaseResult$ = [3, n0, _URDRp,
    0,
    [_o],
    [() => OperationList]
];
...
export var AttachDisk$ = [9, n0, _ADt,
    { [_ht]: ["POST", "/ls/api/2016-11-28/AttachDisk", 200] }, () => AttachDiskRequest$, () => AttachDiskResult$
];
export var AttachInstancesToLoadBalancer$ = [9, n0, _AITLB,
...
export var AttachLoadBalancerTlsCertificate$ = [9, n0, _ALBTC,
...
export var CreateContainerServiceRegistryLogin$ = [9, n0, _CCSRL,
...
export var CreateLoadBalancerTlsCertificate$ = [9, n0, _CLBTC,
...
export var CreateRelationalDatabaseSnapshot$ = [9, n0, _CRDS,
...
export var DeleteBucketAccessKey$ = [9, n0, _DBAK,
...
export var DeleteContainerService$ = [9, n0, _DCS,
...
export var DeleteLoadBalancerTlsCertificate$ = [9, n0, _DLBTC,
...
export var DetachCertificateFromDistribution$ = [9, n0, _DCFD,
...
export var DetachDisk$ = [9, n0, _DDet,
    { [_ht]: ["POST", "/ls/api/2016-11-28/DetachDisk", 200] }, () => DetachDiskRequest$, () => DetachDiskResult$
];
export var DetachInstancesFromLoadBalancer$ = [9, n0, _DIFLB,
...
export var GetContainerServiceDeployments$ = [9, n0, _GCSD,
...
export var GetContainerServiceMetricData$ = [9, n0, _GCSMD,
...
export var GetDistributionMetricData$ = [9, n0, _GDMD,
...
export var GetLoadBalancerTlsPolicies$ = [9, n0, _GLBTP,
...
export var GetRelationalDatabaseBundles$ = [9, n0, _GRDBe,
...
export var GetRelationalDatabaseEvents$ = [9, n0, _GRDE,
...
export var GetRelationalDatabaseLogEvents$ = [9, n0, _GRDLE,
...
export var GetRelationalDatabaseLogStreams$ = [9, n0, _GRDLS,
...
export var GetRelationalDatabaseMasterUserPassword$ = [9, n0, _GRDMUP,
...
export var GetRelationalDatabaseMetricData$ = [9, n0, _GRDMD,
...
export var GetRelationalDatabaseParameters$ = [9, n0, _GRDP,
...
export var GetRelationalDatabaseSnapshots$ = [9, n0, _GRDSe,
...
export var SetResourceAccessForBucket$ = [9, n0, _SRAFB,
...
export var UpdateLoadBalancerAttribute$ = [9, n0, _ULBA,
